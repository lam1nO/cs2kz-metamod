...
- **Невидимки — режим слежки за читерами, v2** (`src/kz/invisible/kz_invisible.*`):
  ...
  **ОТКРЫТЫЙ БАГ (репорт 05.08, причина НЕ установлена):** у зрителя строка невидимки в TAB
  ...
  все чистят только пешки/оружие/партиклы). Разведка одной командой: `kz_profile_rating_badge_enabled 0`
  гасит ВЕСЬ тракт (1) целиком — и записи в контроллеры, и бродкаст.
