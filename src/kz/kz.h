...
// Свой воркшоп-айтем GYMSTRIKE-KZ вместо чужого 3469155349 (KZGlobalTeam): 08.09.2026
// апстрим молча вычистил из своего айтема particles и погасил MHUD на три дня, а тем же
// айтемом к нам едет panorama-разметка худа, меню и крестика.
// Это ФОЛБЭК: рабочее значение берётся из translations/menu-addons.txt (ключ "default"),
// менять надо ОБА — GetBaseAddon() читает файл, а не эту константу.
