...
{
	// Один раз за карту: родные курсы карты и их cyber-номера с этого момента не меняются, а всё,
	// что меняется дальше, инициирует сама платформа (см. шапку функции в заголовке).
