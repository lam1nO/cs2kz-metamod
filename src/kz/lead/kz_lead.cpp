...
// CS2 — ПРОВЕРЕНО ЖИВЬЁМ 17.09.2026 на канарейке: нумерация совпала, 5 даёт аддитивный луч,
// владелец вид одобрил («текущий луч хороший»). Аддитив цвет луча ПРИБАВЛЯЕТ к фону, поэтому
// темнее фона он стать не может — это и есть решение жалобы про тёмные карты, а не частица.
