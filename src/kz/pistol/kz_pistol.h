...
public:
	...
	// Нужен ли спавну наш страйп вообще: в руках уже есть нож своей команды и резолвнутый
	// пистолет (а при выборе «без пистолета» — один только нож). Разбор в kz_pistol.cpp.
