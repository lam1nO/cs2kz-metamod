...
// отдельный сетевой info_particle_system; при потолке набора в 64 зоны без этого ограничения
// вышло бы под тысячу сущностей, которые вдобавок перебирает KZ::quiet::OnCheckTransmit на
// КАЖДЫЙ CheckTransmit для КАЖДОГО получателя.
