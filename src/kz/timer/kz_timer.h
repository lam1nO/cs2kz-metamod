...
enum ResetConfirmAction : u8
{
	...
	RESET_CONFIRM_OTHER,       // !stop/!end/!lj/уход в спектатор — прочие инвалидаторы таймера
	RESET_CONFIRM_COUNT,
};
...
private:
	...
	// Момент первого нажатия по каждому действию, ждущего подтверждения (серверный curtime).
